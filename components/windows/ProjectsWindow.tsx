...
const projects = [
  ...
  },
  {
    ...
    type: 'Internal App',
    desc: 'Admin workflow system for PT Telkom Indonesia',
    tech: 'CodeIgniter, MySQL, Bootstrap, REST API',
  },
  {
    icon: '📁',
    name: 'Data Files Management',
    type: 'Internal App',
    desc: 'Document management system for enterprise use',
